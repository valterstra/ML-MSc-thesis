...
from .qa_trust_v1 import done_metrics, evaluate_gate, ood_metrics, rank_stability, realism_metrics
...
from .variant_search_v1 import apply_variant
...
def evaluate_variant(
    ...
    if readmit_valid["n"] and readmit_valid["n"] > 0:
        ...
        from .qa_trust_v1 import _ece_binary
