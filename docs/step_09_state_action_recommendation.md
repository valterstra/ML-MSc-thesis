...
- selected-set Step 14 training wrapper:
  - `scripts/icu_readmit/step_14_caresim_train_selected.py`
- selected-set Colab notebook:
...
- Step 14 selected track trains:
  - next-state head
  - terminal head
- Step 14 selected track does **not** train a reward head

Pending:

- selected-set Step 12 / Step 13 should still be wired to use the trained
