...
def main() -> int:
    ...
    traj_csv = out_dir / "sim_hourly_v1_counterfactual_paths.csv"
    risk_csv = out_dir / "sim_hourly_v1_counterfactual_risks.csv"
    plot_png = out_dir / "sim_hourly_v1_counterfactual_plot.png"
    summary_json = out_dir / "sim_hourly_v1_counterfactual_summary.json"
    summary_md = out_dir / "sim_hourly_v1_counterfactual_summary.md"
