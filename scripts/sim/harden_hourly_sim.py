...
from careai.sim_hourly.hardening_runner import build_data_manifest, evaluate_variant
from careai.sim_hourly.reporting_trust import trust_summary_markdown
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Autonomous hardening runner for the hourly simulator.")
    parser.add_argument("--config", default=str(ROOT / "configs" / "hourly_sim_hardening.yaml"))
