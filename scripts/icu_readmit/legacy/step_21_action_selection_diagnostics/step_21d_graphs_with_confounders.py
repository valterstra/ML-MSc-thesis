"""
Step 21d -- Legacy action-selection diagnostics: causal graphs with confounders.

Same 5 focused graphs as step_21c_focused_causal_graphs, but adds three static confounders to each graph:
...
Outputs: reports/icu_readmit/legacy/step_21_action_selection_diagnostics/step_21d_graphs_with_confounders/
...
Usage:
    ...
    python scripts/icu_readmit/legacy/step_21_action_selection_diagnostics/step_21d_graphs_with_confounders.py
    python scripts/icu_readmit/legacy/step_21_action_selection_diagnostics/step_21d_graphs_with_confounders.py --graph vasopressor ivfluid
"""
...
# ---------------------------------------------------------------------------
# Graph definitions (unchanged from step_21c)
# ---------------------------------------------------------------------------
GRAPHS = {
    'vasopressor': {
...
# ---------------------------------------------------------------------------
# PC algorithm (unchanged logic from step_21c)
# ---------------------------------------------------------------------------
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Step 21d: Causal discovery with confounders (PC only)')
    ...
    parser.add_argument('--out-dir', default=str(
        PROJECT_ROOT / 'reports' / 'icu_readmit' / 'legacy' / 'step_21_action_selection_diagnostics' / 'step_21d_graphs_with_confounders'))
    ...
    log_file = args.log or str(PROJECT_ROOT / 'logs' / 'step_21d_graphs_with_confounders.log')
    ...
    logging.info("Step 21d started (PC only, with confounders).")
    ...
    logging.info("Step 21d complete.")
