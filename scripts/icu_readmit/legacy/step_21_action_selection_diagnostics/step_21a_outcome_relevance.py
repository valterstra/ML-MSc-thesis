"""
Step 21a -- Legacy action-selection diagnostics: outcome-relevant features.
...
This is the first half of a two-stage variable selection:
  ...
  Step 21a (this script): outcome relevance -- which features predict readmission?
  Step 21b (next script): transition relevance -- which features respond to actions?
...
Usage:
    ...
    python scripts/icu_readmit/legacy/step_21_action_selection_diagnostics/step_21a_outcome_relevance.py
    python scripts/icu_readmit/legacy/step_21_action_selection_diagnostics/step_21a_outcome_relevance.py --top-n 20
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-dir', default=os.path.join(
        REPO_DIR, 'reports', 'icu_readmit', 'legacy', 'step_21_action_selection_diagnostics', 'step_21a_outcome_relevance'))
    parser.add_argument('--top-n', type=int, default=20,
                        help='Top N features to include per group in summary JSON')
    parser.add_argument('--log', default=None)
    args = parser.parse_args()

    log_file = args.log or os.path.join(REPO_DIR, 'logs', 'step_21a_outcome_relevance.log')
    ...
    logging.info("Step 21a started. input=%s", args.input)
    ...
    logging.info("Step 21a complete.")
