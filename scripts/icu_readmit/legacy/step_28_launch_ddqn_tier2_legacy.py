"""
Detached launcher for step_11b_ddqn_tier2.py.
...
LOG_FILE   = os.path.join(BASE_DIR, 'logs', 'legacy', 'icu_readmit', 'step_28_launch_ddqn_tier2_legacy.log')
...
import torch
sys.argv = ['step_11b'] + {ARGS!r}
exec(open(r'{BASE_DIR}\\\\scripts\\\\icu_readmit\\\\legacy\\\\step_26_ddqn_tier2_legacy.py').read())
"""
