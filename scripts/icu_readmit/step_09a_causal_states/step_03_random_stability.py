...
OUTPUTS
-------
  reports/icu_readmit/step_09a_causal_states/random_stability_results.csv
  reports/icu_readmit/step_09a_causal_states/random_stability_summary.json
...
Usage:
    ...
    python scripts/icu_readmit/step_09a_causal_states/step_03_random_stability.py
    python scripts/icu_readmit/step_09a_causal_states/step_03_random_stability.py --smoke
    python scripts/icu_readmit/step_09a_causal_states/step_03_random_stability.py \\
