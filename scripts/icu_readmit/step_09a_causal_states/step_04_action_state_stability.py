...
OUTPUT
------
  reports/icu_readmit/step_09a_causal_states/action_state_results/
    frac_<drug>_results.csv   -- ranked state list per drug
  reports/icu_readmit/step_09a_causal_states/action_state_frequency_matrix.csv
  reports/icu_readmit/step_09a_causal_states/action_state_summary.json

Usage:
    source ../.venv/Scripts/activate
    python scripts/icu_readmit/step_09a_causal_states/step_04_action_state_stability.py --smoke
    python scripts/icu_readmit/step_09a_causal_states/step_04_action_state_stability.py
"""
