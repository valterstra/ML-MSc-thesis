...
This is step 1 of the state->readmission causal discovery track
(scripts/icu_readmit/step_09a_causal_states/).

OUTPUTS
-------
  data/processed/icu_readmit/step_09a_causal_states/stay_level.parquet
  reports/icu_readmit/step_09a_causal_states/stay_level_summary.json

Usage:
    source ../.venv/Scripts/activate
    python scripts/icu_readmit/step_09a_causal_states/step_01_stay_level.py
    python scripts/icu_readmit/step_09a_causal_states/step_01_stay_level.py --smoke
    python scripts/icu_readmit/step_09a_causal_states/step_01_stay_level.py \\
        --input data/processed/icu_readmit/ICUdataset.csv \\
        --out-dir data/processed/icu_readmit/step_09a_causal_states
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--out-dir', default=str(
            PROJECT_ROOT / 'data' / 'processed' / 'icu_readmit' / 'step_09a_causal_states'),
