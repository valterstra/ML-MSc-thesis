...
stay untouched:
  ...
  reports/icu_readmit/step_09a_causal_states/random_stability_results_robust.csv
  reports/icu_readmit/step_09a_causal_states/random_stability_summary_robust.json
  reports/icu_readmit/step_09a_causal_states/random_stability_state_pool_robust.json

Usage:
    python scripts/icu_readmit/step_09a_causal_states/step_03b_random_stability_robust.py
    python scripts/icu_readmit/step_09a_causal_states/step_03b_random_stability_robust.py --smoke
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input",
        default=str(
            PROJECT_ROOT / "data" / "processed" / "icu_readmit" / "step_09a_causal_states" / "stay_level.parquet"
        ),
        help="Path to stay_level.parquet (Step 01 output)",
    )
    parser.add_argument(
        "--report-dir",
        default=str(PROJECT_ROOT / "reports" / "icu_readmit" / "step_09a_causal_states"),
        help="Directory for robust Step 03b outputs",
    )
    parser.add_argument(
        "--state-ranking-path",
        default=str(PROJECT_ROOT / "reports" / "icu_readmit" / "step_09a_causal_states" / "state_variable_ranking.csv"),
