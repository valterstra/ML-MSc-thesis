...
-------
  ...
  reports/icu_readmit/step_09_state_action_selection/static_variable_ranking.csv
  reports/icu_readmit/step_09_state_action_selection/variable_ranking_summary.json
...
Usage:
    ...
    python scripts/icu_readmit/step_09_state_action_selection/step_02_variable_ranking.py
    python scripts/icu_readmit/step_09_state_action_selection/step_02_variable_ranking.py --smoke
"""
