"""
Step 09b.3d -- Causal discovery: discharge state -> readmission.
...
Outputs: reports/icu_readmit/step_09b_causal_actions/step_03d_discharge_readmission/

Usage:
    source ../.venv/Scripts/activate
    python scripts/icu_readmit/step_03d_discharge_readmission.py
    python scripts/icu_readmit/step_03d_discharge_readmission.py --graph vasopressor ivfluid
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Step 09b.3d: Discharge state -> readmission causal graphs')
    ...
    parser.add_argument('--out-dir', default=str(
        PROJECT_ROOT / 'reports' / 'icu_readmit' / 'step_09b_causal_actions' / 'step_03d_discharge_readmission'))
    ...
    log_file = args.log or str(PROJECT_ROOT / 'logs' / 'step_09b_step_03d_discharge_readmission.log')
    ...
    logging.info("Step 09b.3d started (discharge state -> readmission).")
    ...
    logging.info("Step 09b.3d complete.")
