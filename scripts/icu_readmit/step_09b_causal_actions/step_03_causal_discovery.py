"""
Step 09b.3 -- Causal discovery: focused action -> state -> readmission graphs.
...
OUTPUTS
-------
  reports/icu_readmit/step_09b_causal_actions/step_03_causal_discovery/
    <graph_name>/
...
Usage:
    ...
    python scripts/icu_readmit/step_03_causal_discovery.py
    python scripts/icu_readmit/step_03_causal_discovery.py --graph vasopressor antibiotic
    python scripts/icu_readmit/step_03_causal_discovery.py --algorithms pc lingam
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-dir', default=str(
        PROJECT_ROOT / 'reports' / 'icu_readmit' / 'step_09c'))
    ...
    log_file  = args.log or str(PROJECT_ROOT / 'logs' / 'step_09b_step_03_causal_discovery.log')
    ...
    logging.info("Step 09b.3 started.")
    ...
    logging.info("Step 09b.3 complete.")
