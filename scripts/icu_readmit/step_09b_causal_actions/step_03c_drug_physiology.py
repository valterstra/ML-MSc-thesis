"""
Step 09b.3c -- Causal discovery: drug -> physiology only (no readmission node).
...
tested separately in step_03d_discharge_readmission using absolute discharge-state values.
...
Outputs: reports/icu_readmit/step_09b_causal_actions/step_03c_drug_physiology/

Usage:
    source ../.venv/Scripts/activate
    python scripts/icu_readmit/step_03c_drug_physiology.py
    python scripts/icu_readmit/step_03c_drug_physiology.py --graph vasopressor ivfluid
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Step 09b.3c: Drug -> physiology causal graphs (no readmission)')
    ...
    parser.add_argument('--out-dir', default=str(
        PROJECT_ROOT / 'reports' / 'icu_readmit' / 'step_09b_causal_actions' / 'step_03c_drug_physiology'))
    ...
    log_file = args.log or str(PROJECT_ROOT / 'logs' / 'step_09b_step_03c_drug_physiology.log')
    ...
    logging.info("Step 09b.3c started (drug -> physiology, no readmission).")
    ...
    logging.info("Step 09b.3c complete.")
